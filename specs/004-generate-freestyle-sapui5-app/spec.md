...
2. **Given** 오류 복구 요구가 001 handoff에 포함되었을 때, **When** 프로젝트를 생성하고 검증하면, **Then** 오류 유형별 안내, 재시도와 취소 흐름이 요구사항에 추적된다.
...
- **FR-018**: 시스템은 001 handoff와 사용자의 application 생성 요청이 확인된 후에만 프로젝트를 생성해야 한다.
