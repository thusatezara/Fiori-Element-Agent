...
|---|---|---|---|
| FR-001~FR-004 | US3, handoff·boundary gate | T004, T010, T026, T032~T034 | invalid handoff, dependency, path/secret guard |
| FR-005~FR-010 | US1, domain/service planning | T005~T019 | semantic, compile, contract, snapshot consistency |
